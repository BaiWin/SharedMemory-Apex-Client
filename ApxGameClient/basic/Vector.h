...
{
	Vector6() {};
	Vector6(float _x, float _y, float _z, float _x1, float _y1, float _z1)
	{
		x = _x;
		y = _y;
		z = _z;
	...
	bool operator==(const Vector6& other) const
	{
		return (x == other.x) && (y == other.y) && (z == other.z) && (x1 == other.x1) && (y1 == other.y1) && (z1 == other.z1);
	}
};